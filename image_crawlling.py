#구글 모듈
#사자,호랑이,표범,토끼,거북이,앵무새,독수리,말,판다,곰
#Lion, Tiger, Leopard, Rabbit, Turtle, Parrot, Eagle, Horse, Panda, Bear
...
for searchKeyword,keyword in search_datas:
   ...
   save_path = f"d:\\imgs\\{keyword}\\" #d:\\imgs\\google\\{keyword}\\
   ...
   driver.quit()
from naver_crawooling import get_naver
